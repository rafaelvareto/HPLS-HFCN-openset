...
echo 'VGGFACE'
python ../main_openset_fc.py -p ../features/ -f VGGFACE-15-DEEP-FEATURE-VECTORS.bin -r 10 -m 100 -ks 0.1
python ../main_openset_fc.py -p ../features/ -f VGGFACE-15-DEEP-FEATURE-VECTORS.bin -r 10 -m 200 -ks 0.1
python ../main_openset_fc.py -p ../features/ -f VGGFACE-15-DEEP-FEATURE-VECTORS.bin -r 10 -m 300 -ks 0.1
python ../main_openset_fc.py -p ../features/ -f VGGFACE-15-DEEP-FEATURE-VECTORS.bin -r 10 -m 400 -ks 0.1
python ../main_openset_fc.py -p ../features/ -f VGGFACE-15-DEEP-FEATURE-VECTORS.bin -r 10 -m 500 -ks 0.1
echo 'PUBFIG83'
